package prolab;
public class KobeBryant extends Sporcu {
	...
	public KobeBryant() {
		super();
                this.sporcuIsim = "Kobe Bryant ";
                this.sporcuTakim = "Lakers ";
                this.fileName = "bkb.png";
		this.sporcuPuani = 80;
                this.ikilik =80;
                this.serbestAtis =75;
                this.ucluk=85;
	...
	public KobeBryant(String basketbolcuAdi, String basketbolcuTakim,String fileName,int sporcuPuani) {
