package prolab;
public class StephenCurry extends Sporcu {
	...
	public StephenCurry() {
		super();
                this.sporcuIsim = "Stephen Curry ";
                this.sporcuTakim = "The Town ";
                this.fileName = "bsc.png";
		this.sporcuPuani = 70;
                this.ikilik =80;
                this.serbestAtis =65;
                this.ucluk=70;
	...
	public StephenCurry(String basketbolcuAdi, String basketbolcuTakim,String fileName,int sporcuPuani) {
