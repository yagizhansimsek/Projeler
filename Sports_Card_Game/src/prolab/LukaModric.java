package prolab;
public class LukaModric extends Sporcu {
	...
	public LukaModric() {
		super();
                this.sporcuIsim = "Luka Modric ";
                this.sporcuTakim = "Real Madrid ";
                this.fileName = "flmr.png";
		this.sporcuPuani = 75;
                this.penalti =70;
                this.serbestAtis =85;
	...
	public LukaModric(String futbolcuAdi, String futbolcuTakim,String fileName,int sporcuPuani) {
