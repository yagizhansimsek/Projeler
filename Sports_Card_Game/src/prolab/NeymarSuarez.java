package prolab;
public class NeymarSuarez extends Sporcu {
	...
	public NeymarSuarez() {
		super();
                this.sporcuIsim = "Neymar Suarez ";
                this.sporcuTakim = "Paris Saint-Germain ";
                this.fileName = "fnm.png";
		this.sporcuPuani = 80;
                this.penalti =80;
                this.serbestAtis =80;
	...
	public NeymarSuarez(String futbolcuAdi, String futbolcuTakim,String fileName,int sporcuPuani) {
